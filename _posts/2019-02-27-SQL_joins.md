...
These cartoons suggest that a table is abtractly represented as some sort of collection of $$N$$-simplices (possibly of varying dimension).  However, it's nut just a set.  It's a multiset.  **We can formally represent a table as a multiset equipped with a collection of morphisms called "columns".** Lets unpack this.
